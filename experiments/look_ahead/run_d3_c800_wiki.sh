...
echo "=== block_head_corr_ffn_add D=3 C=800 wiki ==="
cd /home/ubuntu/look_ahead && PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True \
  ...
  --amp 2>&1 | tee /home/ubuntu/look_ahead6/logs/corr_ffn_add_d3_c800_wiki.log
