...
# 1. rpemb4 qkv: 100K at lr=5e-4
echo "$(date): rpemb4 qkv 100K from scratch on GPU 2"
/home/ubuntu/exp8/venv/bin/python train.py \
    ...
    --models shared_rpemb4_qkv \
    --checkpoint_dir checkpoints/shared_rpemb4_qkv \
    --gpu 2

# 2. 50K at lr=2e-4
echo "$(date): rpemb4 qkv lr=2e-4 on GPU 2"
/home/ubuntu/exp8/venv/bin/python continue_training.py \
    --checkpoint checkpoints/shared_rpemb4_qkv/shared_rpemb4_qkv_best.pt \
    --data_dir /home/ubuntu/look_ahead/look_ahead/data_owt \
    --lr 2e-4 --max_iters 50000 --batch_size 32 \
    --eval_interval 5000 --extrap_interval 5000 \
    --eval_lengths 512,1024,2048,4096,8192,16384 \
    --bf16 \
    --checkpoint_dir checkpoints/shared_rpemb4_qkv_sched_150k \
    --gpu 2

# 3. 50K at lr=5e-5
echo "$(date): rpemb4 qkv lr=5e-5 on GPU 2"
/home/ubuntu/exp8/venv/bin/python continue_training.py \
    --checkpoint checkpoints/shared_rpemb4_qkv_sched_150k/shared_rpemb4_qkv_best.pt \
    --data_dir /home/ubuntu/look_ahead/look_ahead/data_owt \
    --lr 5e-5 --max_iters 50000 --batch_size 32 \
    --eval_interval 5000 --extrap_interval 5000 \
    --eval_lengths 512,1024,2048,4096,8192,16384 \
    --bf16 \
    --checkpoint_dir checkpoints/shared_rpemb4_qkv_sched_200k \
    --gpu 2
