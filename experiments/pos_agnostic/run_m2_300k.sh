...
echo "Launching m2 control 300K on GPU 2"
/home/ubuntu/exp8/venv/bin/python continue_training.py \
    --checkpoint checkpoints/monoidal2_control_200k/monoidal2_best.pt \
    ...
    --bf16 \
    --checkpoint_dir checkpoints/monoidal2_control_300k \
    --gpu 2
echo "m2 control 300K done."
