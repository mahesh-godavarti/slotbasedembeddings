...
echo "Launching j2 angle 300K on GPU 1"
/home/ubuntu/exp8/venv/bin/python continue_training.py \
    --checkpoint checkpoints/joformer2_angle_200k/joformer2_best.pt \
    ...
    --bf16 \
    --checkpoint_dir checkpoints/joformer2_angle_300k \
    --gpu 1
echo "j2 angle 300K done."
