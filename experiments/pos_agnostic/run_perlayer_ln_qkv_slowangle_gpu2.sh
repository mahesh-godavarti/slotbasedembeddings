...
nohup /home/ubuntu/exp8/venv/bin/python train.py \
    ...
    --lr 5e-4 --angle_lr 1e-4 --max_iters 100000 --eval_interval 5000 --extrap_interval 10000 \
    --eval_lengths 512,1024,2048,4096,8192,16384 \
    --window_size 999999 --dropout 0.1 --bf16 \
    --models perlayer_ln_qkv \
    --checkpoint_dir checkpoints/new_exp_slowangle \
    --gpu 2 \
    >> logs/pafl_perlayer_ln_qkv_slowangle.log 2>&1 &

echo "Launched perlayer_ln_qkv (angle_lr=1e-4) on GPU 2"
