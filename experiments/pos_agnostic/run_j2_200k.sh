...
# GPU 0: joformer2 control — wait for current run to finish, then continue 100K
...
echo "Launching joformer2 control 200K on GPU 0"
/home/ubuntu/exp8/venv/bin/python continue_training.py \
    --checkpoint checkpoints/joformer2_from_frozen_control/joformer2_best.pt \
    ...
    --bf16 \
    --checkpoint_dir checkpoints/joformer2_control_200k \
    --gpu 0
echo "joformer2 control 200K done."
