"""CIFAR-100 runner for axial random-mix rotation (commutative + full mixing)."""
import sys
...
from models.rope_vit_axial_randmix import RoPEViT as RoPEViTAxialRandMix
import argparse
...
def main():
    ...
    model.model = RoPEViTAxialRandMix(
        image_size=32,
        patch_size=[4, 4],
        num_classes=100,
        dim=cfg["dim"],
    ...
    print(f"Axial random-mix rotation, rotate_v={args.rotate_v}, n_rounds={args.n_rounds}")
