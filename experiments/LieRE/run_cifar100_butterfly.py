"""CIFAR-100 runner for butterfly rotation (product of 2x2 rotations + permutations)."""
import sys
...
from models.rope_vit_butterfly import RoPEViT as RoPEViTButterfly
import argparse
...
def main():
    ...
    # Create LiereImageClassification and swap in butterfly model
    ...
    # Replace with butterfly model
    model.model = RoPEViTButterfly(
        image_size=32,
        patch_size=[4, 4],
        num_classes=100,
        dim=cfg["dim"],
    ...
    print(f"Butterfly rotation, rotate_v={args.rotate_v}, n_rounds={args.n_rounds}")
