"""CIFAR-100 runner for axial Cayley rotation (Cayley transform instead of matrix_exp)."""
import sys
...
from models.rope_vit_axial_cayley import RoPEViT as RoPEViTAxialCayley
import argparse
...
def main():
    ...
    # Create LiereImageClassification and swap in axial cayley model
    ...
    # Replace with axial cayley model
    model.model = RoPEViTAxialCayley(
        image_size=32,
        patch_size=[4, 4],
        num_classes=100,
        dim=cfg["dim"],
    ...
    print(f"Axial Cayley rotation, rotate_v={args.rotate_v}")
