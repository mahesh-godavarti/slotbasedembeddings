"""CIFAR-100 runner for block-diagonal 2x2 rotation (our JoFormer approach).
Uses LieRE's training framework but replaces dense rotations with block-diagonal."""
import sys
...
from models.rope_vit_block_v import RoPEViT as RoPEViTBlockV
...
def main():
    ...
    # Create LiereImageClassification and swap in our block-diagonal model
    ...
    # Replace LieRE model with block-diagonal version
    model.model = RoPEViTBlockV(
        image_size=32,
        patch_size=[4, 4],
        num_classes=100,
        dim=cfg["dim"],
    ...
    print(f"Block-diagonal rotation, rotate_v={args.rotate_v}")
