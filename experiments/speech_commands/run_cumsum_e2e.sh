...
echo "=== CumsumE2E (fixed, l1=400, w=20) ==="
PYTHONUNBUFFERED=1 python speech_commands.py --model cumsum_e2e --n_embed 40 --n_layers 4 --window_l1 400 --window 20 --epochs 40 2>&1 | tee cumsum_e2e_n40_l4_w20.log

echo "=== CumsumE2EMod (mod, l1=400, w=20) ==="
PYTHONUNBUFFERED=1 python speech_commands.py --model cumsum_e2e_mod --n_embed 40 --n_layers 4 --window_l1 400 --window 20 --epochs 40 2>&1 | tee cumsum_e2e_mod_n40_l4_w20.log
