...
echo "=== Fixed w10 l8, time_stretch 0.8-1.2, affine=True ==="
...
echo ""
echo "=== Past-phase Mod w10 l8, time_stretch 0.8-1.2, affine=True ==="
...
echo ""
echo "=== Derot-prev Mod w10 l8, time_stretch 0.8-1.2, affine=True (derot Φ(t-1), rerot Φ(t)) ==="
